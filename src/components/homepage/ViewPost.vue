            ...
            <div v-for="post in posts" :key="post._id">
              <div class="card mb-2">
                ...
                <div class="d-flex align-items-center ms-3">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="like-icon" @click="like(post.id)">
                    <path
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="comment-icon" @click="showCommentsModal(post)" data-bs-toggle="modal" data-bs-target="#commentsModal">
                    <path
